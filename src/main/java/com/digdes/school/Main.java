    ...
    public static void main(String... args) {
        ...
        try {
            ...
            List<Map<String, Object>> result1 = starter
                    .execute("INSERT   VALUES  'lastName' = 'FedoroWhereandorvPsina' , 'id'= 3, 'age' =40, 'active'=true");
            System.out.println(result1);
            //Изменение значения которое выше записывали
            List<Map<String, Object>> result2 = starter
                   .execute("UPDaTE VALUES 'lastName' = 'BABAiKA)saas' , 'id'= 39, 'age' =40, 'cost' =56.2, 'active'=true where 'lastName' like %asd%");
            ...
            List<Map<String, Object>> result5 = starter
                    .execute("UPDATE VALUES 'active'=true  where 'active'=false  AND  'id'=1 ");
